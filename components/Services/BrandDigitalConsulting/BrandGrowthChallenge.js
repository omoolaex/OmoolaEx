      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        />
          <h2 className="font-poppins font-semibold text-2xl sm:text-3xl lg:text-4xl mb-6">
            The Brand & Growth Challenge
          </h2>

          <p className="text-[#0E1A3C] leading-relaxed mb-4">
          Many businesses invest in marketing without a strategy—posting
          inconsistently, running ads without clear objectives, or building
          brands that look good but don’t convert. Others have strong products
          but struggle to communicate their value effectively or reach the right
          audience.
          <br />
          <br />
          Effective brand and digital growth consulting bridges this gap. It’s
          about understanding who you’re serving, what makes you different, how
          to communicate that clearly, and which digital channels will drive the
          ...
          >
            Discover how OmoolaEx tailors branding for growth →
          </a>
        </motion.div>
      </div>
    </section>
