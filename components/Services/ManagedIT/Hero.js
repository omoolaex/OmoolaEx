...
export default function ManagedITHero() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              Reliable IT Support and Empowered Teams
            </motion.h1>
            ...
            >
              Technology keeps your business running, but managing it shouldn&apos;t consume all your resources. 
              OmoolaEx provides managed IT services in Lagos and across Nigeria that ensure your systems work 
              reliably while our capacity building programs equip your team with the digital skills they need 
              to thrive. From day-to-day technical support to comprehensive cybersecurity training, we keep 
              your technology running and your people growing.
            </motion.p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center lg:justify-start text-sm text-[#C9D8FF]">
              <div className="flex items-center gap-2">
                <Headphones className="w-5 h-5 text-[#00D1FF]" />
