...
export default function ManagedITCTA() {
  return (
    <section className="relative bg-gradient-to-b from-[#0B1736] via-[#0E1A3C] to-[#14264C] text-white py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          Whether you need comprehensive managed IT services in Lagos, cybersecurity awareness
          training for your team, or technical support that keeps your business running smoothly,
          OmoolaEx is here to help.
          <br />
          <strong>Contact us today</strong> to discuss your IT management and training needs.
        </motion.p>
