      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              Off-the-shelf software rarely fits perfectly. Your business has unique
              workflows, specific customer needs, and particular challenges that
              generic solutions can’t address. OmoolaEx delivers custom software
              development in Nigeria that’s built around how you actually operate—from
              websites and mobile applications to enterprise systems and seamless
              integrations that make your technology work together.
            </motion.p>
            ...
            >
              We create digital solutions your customers love and systems your team can actually use.
            </motion.p>
